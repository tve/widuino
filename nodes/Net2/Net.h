...
// Operating modes
#define NET_MODE_NORMAL   0   // normal mode: full power, 115Kbps
#define NET_MODE_LOW      1   // low power mode for testing: low tx power, low sensitivity, 115Kbps
#define NET_MODE_SLOW     2   // slow mode for extended range: full power, 19Kbps
...
public:
  ...
  // @radio_mode is one of NET_MODE_*
  void init(uint8_t node_id, uint8_t radio_mode=NET_MODE_NORMAL, uint8_t group_id=0xD4);
